...
/**
 * Initialize `Framer` with the given `options`.
 *
 * @param {Object} [options]
 * @api public
 */

var Framer = exports = module.exports = function Framer (options) {
  stream.Transform.call(this, { objectMode: true });
}

/**
 * `Framer` inherits from `stream.Transform`.
 */

inherits(Framer, stream.Transform);
...
Framer.prototype._transform = function (chunk, encoding, done) {
