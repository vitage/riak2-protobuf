...
Decoder.prototype.visitContent = function (content) {
  ...
  if (content.content_type == 'application/json') {
    try {
      var value = content.value.toString(content.charset || 'utf8');
...
/**
 * Visit an `Error` response message.
 *
 * @param {Object} data
 * @api public
 */
...
Decoder.prototype.visitRpbPutResp =
Decoder.prototype.visitRpbDelReq = function (data) {
  this.visitContent(data.content);
};

/**
 * Visit a `ListBuckets` response message.
 *
 * @param {Object} data
 * @api public
 */
...
/**
 * Visit a `ListKeys` response message.
 *
 * @param {Object} data
 * @api public
 */
...
/**
 * Visit a `GetBucket` response or `SetBucket` request message.
 *
 * @param {Object} data
 * @api public
 */
...
/**
 * Visit a `MapRed` request message.
 *
 * @param {Object} data
 * @api public
 */
